...
describe('Admin API', () => {
    ...
    beforeEach(async () => {
        ...
        adminToken = jwt.sign({ userId: adminUser._id }, process.env.JWT_SECRET, { expiresIn: '30d' });
        ...
        userToken = jwt.sign({ userId: regularUser._id }, process.env.JWT_SECRET, { expiresIn: '30d' });
    });
