...
const PomodoroTimer = lazy(() =>
  import('./components/pomodoro/PomodoroTimer').then((module) => ({
...
const ClockInOut = lazy(() =>
  import('./components/ClockInOut').then((module) => ({ default: module.ClockInOut }))
);
const SpotifyPanel = lazy(() =>
  import('./components/SpotifyPanel').then((module) => ({ default: module.SpotifyPanel }))
);
const Settings = lazy(() =>
...
const AdminShell = lazy(() =>
  import('./admin/components/layout/AdminShell').then((module) => ({ default: module.AdminShell }))
);
const AdminDashboard = lazy(() =>
  import('./admin/pages/AdminDashboard').then((module) => ({ default: module.AdminDashboard }))
);
const UserManagement = lazy(() =>
  import('./admin/pages/UserManagement').then((module) => ({ default: module.UserManagement }))
);
const AuditLogsPage = lazy(() =>
  import('./admin/pages/AuditLogsPage').then((module) => ({ default: module.AuditLogsPage }))
);
const LiveActivityPage = lazy(() =>
  import('./admin/pages/LiveActivityPage').then((module) => ({ default: module.LiveActivityPage }))
);
const SystemHealthPage = lazy(() =>
  import('./admin/pages/SystemHealthPage').then((module) => ({ default: module.SystemHealthPage }))
);
const SystemSettingsPage = lazy(() =>
  import('./admin/pages/SystemSettingsPage').then((module) => ({
