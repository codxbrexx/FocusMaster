...
describe('TaskManager', () => {
    ...
    beforeEach(() => {
        ...
        (useTaskStore as any).mockReturnValue({
            tasks: [
                { _id: '1', title: 'Test Task 1', isCompleted: false, priority: 'high', estimatedPomodoros: 2, completedPomodoros: 0, category: 'Work' },
                { _id: '2', title: 'Completed Task', isCompleted: true, priority: 'low', estimatedPomodoros: 1, completedPomodoros: 1, category: 'Personal' },
            ],
            addTask: mockAddTask,
