                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            {user ? (
                                ...
                                <>
                                    <Link to="/login">
                                        <Button variant="ghost" className="rounded-full hover:bg-white/10">Log in</Button>
                                    </Link>
                                    <Link to="/register">
                        ...
                        <div className="flex flex-col gap-6 text-center">
                            ...
                            {user ? (
                                <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)}>
                                    <Button size="lg" className="w-full rounded-full text-lg">Go to Dashboard</Button>
                                </Link>
                            ) : (
                                <>
                                    <Link to="/login" onClick={() => setMobileMenuOpen(false)}>
                                        <Button variant="ghost" size="lg" className="w-full rounded-full text-lg">Log in</Button>
                                    </Link>
                                    <Link to="/register" onClick={() => setMobileMenuOpen(false)}>
                                        <Button size="lg" className="w-full rounded-full text-lg bg-white text-black">Get Started</Button>
                                    </Link>
                                </>
                            )}
                        </div>
