    ...
    <section className="relative z-10 container mx-auto px-6 py-20 space-y-32">
        ...
        >
          ...
          <ul className="space-y-4 text-muted-foreground text-lg">
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-blue-500" /> Fully customizable session
              lengths
            </li>
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-blue-500" /> Auto-start cycles and smart break
              management
            </li>
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-blue-500" /> Every session stored for
              analytics
            </li>
          </ul>
        </motion.div>
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
        <div className="lg:w-1/2 space-y-6">
          ...
          <ul className="space-y-4 text-muted-foreground text-lg">
            ...
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-green-500" /> Perfect for study plans and
              sprint planning
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2 space-y-6">
          ...
          <ul className="space-y-4 text-muted-foreground text-lg">
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-500" /> Daily and weekly performance
              insights
            </li>
            <li className="flex items-center gap-3">
            ...
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-500" /> Session logs and breakdown
              reports
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2 space-y-6">
          ...
          <ul className="space-y-4 text-muted-foreground text-lg">
            ...
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-yellow-500" /> Perfect for freelancers and
              remote workers
            </li>
          </ul>
        </div>
