...
export const CTASection = () => {
  ...
  return (
    <section
      id="pricing"
      className="relative z-10 py-32 text-center bg-gradient-to-b from-transparent to-primary/5"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/register">
            <Button
              size="lg"
              className="h-12 px-8 text-base rounded-lg shadow-lg hover:shadow-purple-500/15 transition-all duration-300"
            >
