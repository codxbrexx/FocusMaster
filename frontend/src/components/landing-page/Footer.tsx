            ...
            <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
                    ...
                    <p className="text-xs text-muted-foreground">
                        © {new Date().getFullYear()} FocusMaster. <span className="hidden sm:inline">All rights reserved.</span>
                    </p>
                    <span className="hidden md:block text-muted-foreground/30">|</span>
                    <p className="text-xs text-muted-foreground">
                        {/* // build by codxbrexx */}
                        build by <a href="https://github.com/codxbrexx" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-purple-500">codxbrexx</a>
                    </p>
                </div>
                ...
                <div className="flex items-center gap-6">
                    <div className="flex gap-4">
                        ...
                        <SocialLink href="https://github.com/codxbrexx" icon={<Github className="w-4 h-4" />} label="GitHub" />
                        <SocialLink href="https://linkedin/mozammilali" icon={<Linkedin className="w-4 h-4" />} label="LinkedIn" />
                    </div>
                </div>
            </div>
        </footer>
