        ...
        return (
            <div className="flex flex-col items-center justify-center p-8 text-center bg-secondary/20 rounded-xl border border-border/40 mt-10">
                ...
                <p className="text-sm text-muted-foreground max-w-sm mx-auto leading-relaxed">
                    You do not have the required permission <code className="bg-secondary px-1.5 py-0.5 rounded text-destructive text-xs font-mono">{permission}</code> to view this section.
                </p>
            </div>
        );
    }
