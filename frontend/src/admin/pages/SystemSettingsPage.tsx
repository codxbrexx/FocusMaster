        ...
        <RequirePermission permission="MANAGE_SYSTEM">
            <div className="max-w-5xl mx-auto pb-10">
                <header className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">Manage global configurations for FocusMaster.</p>
                </header>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 glass-card rounded-2xl p-6 md:p-8 min-h-[500px]">
                        ...
                        >
                            ...
                            {activeTab === 'notifications' && <div className="text-center text-muted-foreground py-20">Notification settings coming soon.</div>}
                        </motion.div>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div className="grid gap-4 max-w-lg">
                <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="FocusMaster" className="w-full bg-secondary/30 border border-border/50 rounded-lg px-4 py-2 text-foreground focus:border-primary/50 focus:outline-none" />
                </div>
                <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">Support Email</label>
                    <input type="email" defaultValue="support@focusmaster.app" className="w-full bg-secondary/30 border border-border/50 rounded-lg px-4 py-2 text-foreground focus:border-primary/50 focus:outline-none" />
                </div>
            </div>
        </div>
        ...
        <div className="pt-6 border-t border-border/30">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/20 border border-border/40">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Prevent non-admin users from accessing the app.</p>
                </div>
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
                ...
                <input type="number" defaultValue="25" className="w-full bg-secondary/30 border border-border/50 rounded-lg px-4 py-2 text-foreground focus:border-primary/50 focus:outline-none" />
            </div>
            <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Short Break (min)</label>
                <input type="number" defaultValue="5" className="w-full bg-secondary/30 border border-border/50 rounded-lg px-4 py-2 text-foreground focus:border-primary/50 focus:outline-none" />
            </div>
            <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Long Break (min)</label>
                <input type="number" defaultValue="15" className="w-full bg-secondary/30 border border-border/50 rounded-lg px-4 py-2 text-foreground focus:border-primary/50 focus:outline-none" />
            </div>
        </div>
        ...
        <div className="pt-6 border-t border-border/30">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-3">
                    <input type="checkbox" defaultChecked className="w-4 h-4 rounded border-border/50 bg-secondary/30 text-primary focus:ring-primary/50" />
                    <label className="text-sm text-foreground">Auto-start Breaks</label>
                </div>
                <div className="flex items-center gap-3">
                    <input type="checkbox" className="w-4 h-4 rounded border-border/50 bg-secondary/30 text-primary focus:ring-primary/50" />
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/20 border border-border/40">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Require two-factor authentication for all users with MANAGE_SYSTEM permission.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/20 border border-border/40">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Automatically log out inactive users after 1 hour.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-secondary/50 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
