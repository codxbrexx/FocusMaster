        ...
        <div className="w-full md:w-1/3 flex flex-col glass-card rounded-2xl overflow-hidden relative h-full">
          ...
          <div className="p-4 border-b border-border/40 bg-secondary/20">
            ...
            <div className="relative">
              ...
              />
              <Filter
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-primary cursor-pointer transition-colors"
                size={16}
              />
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] uppercase font-mono text-muted-foreground bg-secondary px-1.5 rounded">
                          {user.role}
                        </span>
                      </div>
          ...
          {selectedUser ? (
            ...
            <div className="glass-card rounded-2xl p-12 text-center flex flex-col items-center justify-center h-full opacity-60">
              ...
              <p className="text-sm text-muted-foreground mt-2 max-w-xs mx-auto">
                Click on a user from the list to view their details, audit logs, and manage their
                status.
              </p>
            </div>
          )}
