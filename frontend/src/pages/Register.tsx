...
import { Loader2, Eye, EyeOff, ArrowRight, CheckCircle2, X, Sparkles } from 'lucide-react';
...
const PasswordStrengthIndicator = ({ password }: { password: string }) => {
  ...
  return (
    <div className="flex gap-2 items-center mt-2">
      ...
      <span className="text-[11px] text-[#666560] capitalize">{strength}</span>
    </div>
  );
};
        ...
        <div className="lg:col-span-7 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
          ...
          <div className="max-w-xl mb-8">
            ...
            <p className="font-serif italic text-lg sm:text-xl text-[#666560] mt-3">
              Join thousands of students and professionals mastering deep work with AI insights
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {step === 1 && (
                <>
                  ...
                  <button
                    ...
                    disabled={isAnyLoading}
                  >
                    Continue with email <ArrowRight className="h-4 w-4 ml-1" />
                  </button>
                </>
              )}
              ...
              {step === 2 && (
                <>
                  ...
                  <button
                    type="button"
                    className="w-full text-xs text-[#666560] hover:text-[#191918] transition-colors py-1 text-center"
                    onClick={() => setStep(1)}
                    disabled={isAnyLoading}
                  >
